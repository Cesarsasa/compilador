 ...
 * @author Charly Ponce
 */
public class FrmPrincipalEsp extends javax.swing.JFrame {

    /**
     * Creates new form FrmPrincipal
     */
    public FrmPrincipalEsp() {
        initComponents();
    ...
    private void analizarLexico() throws IOException{
        ...
        Lexer2 lexer = new Lexer2(new StringReader(expr));
        String resultado = "LINEA " + cont + "\t\tSIMBOLO\n";
        while (true) {
            TokensE token = lexer.yylex();
            if (token == null) {
    ...
    private void btnArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnArchivoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmPrincipalEsp.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        Sintax2 s = new Sintax2(new codigo.LexerCup2(new StringReader(ST)));
        ...
        try {
            ...
            Symbol symE = s.getS();
            txtAnalizarSin.setText("Error de sintaxis. Linea: " + (symE.right + 1) + " Columna: " + (symE.left + 1) + ", Texto: \"" + symE.value + "\"");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPrincipalEsp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPrincipalEsp().setVisible(true);
            }
        });
    }
